  ...
  return (
    <main>
      ...
      <section className="manifesto">
        <div className="manifesto-symbol scroll-reveal"><Sparkles size={42} /></div>
        <p className="scroll-reveal" style={{ transitionDelay: '.1s' }}>
      ...
      <section className="projects section-shell" id="projeler">
        <div className="section-heading project-heading scroll-reveal">
          <div>
